...
def opt_run_id(function):
    function = click.option("--run-id", help="Run ID.", type=str, required=True)(
        function
    )
    return function
...
def opt_input_dir(function):
    function = click.option(
        "--input-dir", help="Input directory.", type=str, required=True
    )(function)
    return function
...
def opt_experiment(function):
    function = click.option(
        "--experiment", help="Experiment name or ID.", type=str, required=True
    )(function)
    return function
...
def opt_model(function):
    function = click.option(
        "--model", help="Registered model name.", type=str, required=True
    )(function)
    return function
...
def opt_verbose(function):
    function = click.option(
        "--verbose", type=bool, help="Verbose.", default=False, show_default=True
    )(function)
    return function
